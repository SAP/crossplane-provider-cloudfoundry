...
func TestCloudfoundry_Mta(t *testing.T) {
	var dir = "./crs/mta"
	var namespace = "mta-test"
	var feats = map[string]struct {
		...
		"space": {name: "mta-space", obj: &v1alpha1.Space{}},
		"mta":   {name: "e2e-app", obj: &v1alpha1.Mta{}},
	}

	var feat = features.New("CO-159 cloudfoundry e2e test mta").Setup(
