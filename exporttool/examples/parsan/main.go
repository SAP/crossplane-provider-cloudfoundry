...
func main() {
	...
	rfc1035LowerSubdomain := huh.NewNote().Title("RFC1035 Lower-case Subdomain").
	...
	group := huh.NewGroup(input, rfc1035subdomain, rfc1035Label, rfc1035LowerSubdomain, rfc1035LowerLabel)
