...
- [External-Name ADR](docs/crossplane-provider-docs/docs/crossplane-provider-btp/docs/contribution-notes/external-name-handling) (internal documentation for external-name patterns)