...
func (a *CFOrganizationAdapter) FetchResources(ctx context.Context, client client.ProviderClient, filter res.ResourceFilter) ([]res.Resource, error) {
	...
	providerResources, err := client.GetResourcesByType(ctx, "organization", criteria)
...
func (a *CFOrganizationAdapter) MapToResource(providerResource interface{}, managementPolicies []v1.ManagementAction) (res.Resource, error) {
	...
	// Map resource
	managedResource := &v1alpha1.Organization{}
	managedResource.APIVersion = "cloudfoundry.crossplane.io/v1alpha1"
	managedResource.Kind = "Organization"
