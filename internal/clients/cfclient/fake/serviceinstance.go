...
func (m *MockServiceInstance) CreateManaged(ctx context.Context, opt *resource.ServiceInstanceCreate) (string, error) {
	args := m.Called()
	return args.String(0), args.Error(1)
}

// CreateUserProvided mocks ServiceInstance.CreateUserProvided
func (m *MockServiceInstance) CreateUserProvided(ctx context.Context, opt *resource.ServiceInstanceCreate) (*resource.ServiceInstance, error) {
	args := m.Called(opt)
	return args.Get(0).(*resource.ServiceInstance), args.Error(1)
}
