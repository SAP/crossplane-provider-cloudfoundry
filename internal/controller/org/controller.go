...
import (
	...
	org "github.tools.sap/cloud-orchestration/crossplane-provider-cloudfoundry/internal/clients/org"
...
func Setup(mgr ctrl.Manager, o controller.Options) error {
	...
	options := []managed.ReconcilerOption{
		managed.WithExternalConnecter(&connector{kube: mgr.GetClient(), newClientFn: org.NewClient,
