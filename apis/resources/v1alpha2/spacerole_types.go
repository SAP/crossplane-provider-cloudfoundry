...
type SpaceRoleParameters struct {
	...
	// Selector for a Space in resources to populate space.
	// +kubebuilder:validation:Optional
	...
	// +kubebuilder:validation:Enum=Developer;Auditor;Manager;Supporter
	Type SpaceRoleType `json:"type,omitempty" tf:"type,omitempty"`
