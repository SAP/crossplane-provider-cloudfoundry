...
func (in *AppParameters) DeepCopyInto(out *AppParameters) {
	*out = *in
	in.SpaceRef.DeepCopyInto(&out.SpaceRef)
...
func (in *DockerConfiguration) DeepCopyInto(out *DockerConfiguration) {
	*out = *in
	if in.Credentials != nil {
		...
		*out = new(DockerCredentialsSecretRef)
		(*in).DeepCopyInto(*out)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DockerCredentialsSecretRef) DeepCopyInto(out *DockerCredentialsSecretRef) {
	*out = *in
	in.CommonCredentialSelectors.DeepCopyInto(&out.CommonCredentialSelectors)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DockerCredentialsSecretRef.
func (in *DockerCredentialsSecretRef) DeepCopy() *DockerCredentialsSecretRef {
	if in == nil {
		return nil
	}
	out := new(DockerCredentialsSecretRef)
...
func (in *DomainParameters) DeepCopyInto(out *DomainParameters) {
	*out = *in
	...
	in.OrgRef.DeepCopyInto(&out.OrgRef)
	if in.SharedOrgs != nil {
		in, out := &in.SharedOrgs, &out.SharedOrgs
		*out = make([]*string, len(*in))
		for i := range *in {
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SpaceRef) DeepCopyInto(out *SpaceRef) {
	*out = *in
	if in.Space != nil {
		in, out := &in.Space, &out.Space
		*out = new(string)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SpaceRef.
func (in *SpaceRef) DeepCopy() *SpaceRef {
	if in == nil {
		return nil
	}
	out := new(SpaceRef)
