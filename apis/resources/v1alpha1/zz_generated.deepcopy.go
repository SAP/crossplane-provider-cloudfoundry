...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RotatingCredentialBinding) DeepCopyInto(out *RotatingCredentialBinding) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ObjectMeta.DeepCopyInto(&out.ObjectMeta)
	in.Spec.DeepCopyInto(&out.Spec)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RotatingCredentialBinding.
func (in *RotatingCredentialBinding) DeepCopy() *RotatingCredentialBinding {
	if in == nil {
		return nil
	}
	out := new(RotatingCredentialBinding)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *RotatingCredentialBinding) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RotatingCredentialBindingList) DeepCopyInto(out *RotatingCredentialBindingList) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ListMeta.DeepCopyInto(&out.ListMeta)
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]RotatingCredentialBinding, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RotatingCredentialBindingList.
func (in *RotatingCredentialBindingList) DeepCopy() *RotatingCredentialBindingList {
	if in == nil {
		return nil
	}
	out := new(RotatingCredentialBindingList)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *RotatingCredentialBindingList) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RotatingCredentialBindingParameters) DeepCopyInto(out *RotatingCredentialBindingParameters) {
	*out = *in
	if in.Namespace != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RotatingCredentialBindingParameters.
func (in *RotatingCredentialBindingParameters) DeepCopy() *RotatingCredentialBindingParameters {
	if in == nil {
		return nil
	}
	out := new(RotatingCredentialBindingParameters)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RotatingCredentialBindingSpec) DeepCopyInto(out *RotatingCredentialBindingSpec) {
	*out = *in
	in.ResourceSpec.DeepCopyInto(&out.ResourceSpec)
	in.ForProvider.DeepCopyInto(&out.ForProvider)
	if in.RotationFrequency != nil {
		in, out := &in.RotationFrequency, &out.RotationFrequency
		*out = new(metav1.Duration)
		**out = **in
	}
	if in.RotationTTL != nil {
		in, out := &in.RotationTTL, &out.RotationTTL
		*out = new(metav1.Duration)
		**out = **in
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RotatingCredentialBindingSpec.
func (in *RotatingCredentialBindingSpec) DeepCopy() *RotatingCredentialBindingSpec {
	if in == nil {
		return nil
	}
	out := new(RotatingCredentialBindingSpec)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RotatingCredentialBindingStatus) DeepCopyInto(out *RotatingCredentialBindingStatus) {
	*out = *in
	in.ResourceStatus.DeepCopyInto(&out.ResourceStatus)
	if in.ActiveServiceCredentialBinding != nil {
		in, out := &in.ActiveServiceCredentialBinding, &out.ActiveServiceCredentialBinding
		*out = new(ServiceCredentialBindingReference)
		(*in).DeepCopyInto(*out)
	}
	if in.PreviousServiceCredentialBindings != nil {
		in, out := &in.PreviousServiceCredentialBindings, &out.PreviousServiceCredentialBindings
		*out = make([]*ServiceCredentialBindingReference, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
				*out = new(ServiceCredentialBindingReference)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RotatingCredentialBindingStatus.
func (in *RotatingCredentialBindingStatus) DeepCopy() *RotatingCredentialBindingStatus {
	if in == nil {
		return nil
	}
	out := new(RotatingCredentialBindingStatus)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ServiceCredentialBindingReference) DeepCopyInto(out *ServiceCredentialBindingReference) {
	*out = *in
	in.LastRotation.DeepCopyInto(&out.LastRotation)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ServiceCredentialBindingReference.
func (in *ServiceCredentialBindingReference) DeepCopy() *ServiceCredentialBindingReference {
	if in == nil {
		return nil
	}
	out := new(ServiceCredentialBindingReference)
