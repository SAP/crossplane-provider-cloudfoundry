...
func (in *AppObservation) DeepCopyInto(out *AppObservation) {
	*out = *in
	...
	if in.Routes != nil {
		...
		*out = make([]AppRouteObservation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AppRouteObservation) DeepCopyInto(out *AppRouteObservation) {
	*out = *in
	if in.Port != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AppRouteObservation.
func (in *AppRouteObservation) DeepCopy() *AppRouteObservation {
	if in == nil {
		return nil
	}
	out := new(AppRouteObservation)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ServiceInstanceParameters) DeepCopyInto(out *ServiceInstanceParameters) {
	*out = *in
	...
	in.ResourceMetadata.DeepCopyInto(&out.ResourceMetadata)
	if in.SharedSpaces != nil {
		in, out := &in.SharedSpaces, &out.SharedSpaces
		*out = make([]SpaceReference, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
