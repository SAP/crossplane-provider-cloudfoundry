...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in LinksMap) DeepCopyInto(out *LinksMap) {
	{
		in := &in
		*out = make(LinksMap, len(*in))
		for key, val := range *in {
			(*out)[key] = *val.DeepCopy()
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new LinksMap.
func (in LinksMap) DeepCopy() LinksMap {
	if in == nil {
		return nil
	}
	out := new(LinksMap)
...
func (in *ServiceRouteBindingParameters) DeepCopyInto(out *ServiceRouteBindingParameters) {
	*out = *in
	if in.RouteGUIDRef != nil {
		in, out := &in.RouteGUIDRef, &out.RouteGUIDRef
		*out = new(v1.Reference)
		(*in).DeepCopyInto(*out)
	}
	if in.RouteGUIDSelector != nil {
		in, out := &in.RouteGUIDSelector, &out.RouteGUIDSelector
		*out = new(v1.Selector)
		(*in).DeepCopyInto(*out)
	}
	if in.ServiceInstanceGUIDRef != nil {
		in, out := &in.ServiceInstanceGUIDRef, &out.ServiceInstanceGUIDRef
		*out = new(v1.Reference)
		(*in).DeepCopyInto(*out)
	}
	if in.ServiceInstanceGUIDSelector != nil {
		in, out := &in.ServiceInstanceGUIDSelector, &out.ServiceInstanceGUIDSelector
		*out = new(v1.Selector)
		(*in).DeepCopyInto(*out)
	}
	in.ResourceMetadata.DeepCopyInto(&out.ResourceMetadata)
