...
var (
	...
	ServiceKeyGroupKind        = schema.GroupKind{Group: CRDGroup, Kind: ServiceKeyKind}.String()
	ServiceKeyKindAPIVersion   = ServiceKeyKind + "." + CRDGroupVersion.String()
	ServiceKeyGroupVersionKind = CRDGroupVersion.WithKind(ServiceKeyKind)
)
