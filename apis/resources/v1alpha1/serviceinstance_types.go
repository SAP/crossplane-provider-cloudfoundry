...
type Managed struct {
	...
	// 
	// A service offering may set arbitrary default parameters.
	// These may change at any time for new service instances.
	// It is recommended to explicitly specify all parameters.
    //
