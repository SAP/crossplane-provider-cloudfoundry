...
var (
	Space_Kind             = "Space"
	Space_GroupKind        = schema.GroupKind{Group: Group, Kind: Space_Kind}.String()
	Space_KindAPIVersion   = Space_Kind + "." + GroupVersion.String()
	Space_GroupVersionKind = GroupVersion.WithKind(Space_Kind)
)
