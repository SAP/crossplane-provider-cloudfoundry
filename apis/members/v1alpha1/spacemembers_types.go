...
var (
	...
	SpaceMembersGroupKind        = schema.GroupKind{Group: Group, Kind: SpaceMembersKind}.String()
	SpaceMembersKindAPIVersion   = SpaceMembersKind + "." + SchemeGroupVersion.String()
	SpaceMembersGroupVersionKind = SchemeGroupVersion.WithKind(SpaceMembersKind)
)
