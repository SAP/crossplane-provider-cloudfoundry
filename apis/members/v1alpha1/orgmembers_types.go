...
var (
	...
	OrgMembersGroupKind        = schema.GroupKind{Group: Group, Kind: OrgMembersKind}.String()
	OrgMembersKindAPIVersion   = OrgMembersKind + "." + SchemeGroupVersion.String()
	OrgMembersGroupVersionKind = SchemeGroupVersion.WithKind(OrgMembersKind)
)
